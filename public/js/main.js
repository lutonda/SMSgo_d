...
$('#sendmessageform').validate({
    ...
    errorLabelContainer: "div#messageBox1"
  });


  $('#_signInForm').validate({
    rules: {
        username: {
            required: true,
            email:true
...
$('#_signOnForm').validate({
  ...
  $('.switchView').on('click',function(){
    $('div.signOn,div.signIn').addClass('hidden')
